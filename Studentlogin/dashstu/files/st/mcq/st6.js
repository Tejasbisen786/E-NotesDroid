const quizDB = [
    ...
    {
        Question:"Q3: Which of the following are the typical tasks should be performed by test leader?
    ...
    {
        Question:"Q4: Which of the following are typical exit criteria for testing?
        i. costs
    ...
    {
        Question:"Q5: State whether the following statements about different test positions are True or False.
        i. The test manager plans testing activities and chooses the
        tools and controls to be used.
        ii. The test manager plans organize and control the testing
        activities while the tester specifies and executes tests.",
        a: "False, False",
        b: "True, False",
        c: "False, True",
        d: " True, True",
