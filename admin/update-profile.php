...
if(isset($_POST['Submit']))
{
    ...
    $gender=$_POST['gender'];
  $uid=intval($_GET['uid']);
$query=mysqli_query($con,"update users set fname='$fname' ,lname='$lname' , contactno='$contact', year='$year', gender='$gender' where id='$uid'");
				...
				<div class="row">
                  ...
                  <div class="col-md-12">
                      ...
                      <p align="center" style="color:#F00;"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']=""; ?></p>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Academic Year</label>
                              <div class="col-sm-10">
